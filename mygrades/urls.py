...
urlpatterns = [
    ...
    path("process-gradable/<int:student_pk>/", process_gradable_step1, name="process_gradable_step1"),
    path("process-gradable/<int:student_pk>/<str:asem>/<int:quarter>/<int:week>/<int:sem>/", process_gradable_step2, name="process_gradable_step2"),
